...
def insertdata():
       ...
       if v1=="" or v2=="" or v3=="" :
            ...
            try:
                ...
                cursor = con.cursor()
                args=(v1,v2,v3)
                query= "insert into bus_route value(%s,%s,%s)"
...
def delete_data():
       ...
       if v1=="" or v2=="" or v3=="":
            ...
            try:
                ...
                cursor = con.cursor()
                args=(v1)
                query= "delete from bus_route where bus_id=%s"
                cursor.execute(query,args)
                con.commit()
                showinfo("Good","Shabaash")
...
Label(f1,text='Station Name',font=30).grid(row=3,column=3)
var2=Entry(f1,font=11)
var2.grid(row=3,column=4,padx=10,pady=10)

Label(f1,text='Destination name ',font=30).grid(row=3,column=5)
